...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      regional_pricing: {
        Row: {
          ...
          id: string;
          package: Database["public"]["Enums"]["package_tier"];
      ...
      project_bookings: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_bookings_lead_id_fkey";
            columns: ["lead_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "project_bookings_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
    ...
    Enums: {
      app_role: "admin" | "client" | "super_admin" | "project_manager" | "developer" | "support";
      approval_status: "draft" | "submitted" | "approved" | "rejected" | "changes_requested";
      ...
      booking_status:
        ...
        | "cancelled"
        | "expired";
      package_tier: "mvp" | "production_ready" | "enterprise";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
